...
let productos = []
productos.push(new Producto(0, "Aleli", "./img/productos/producto39.jpg", false))
productos.push(new Producto(1, "Geronimo", "./img/productos/producto44.jpg", false))
productos.push(new Producto(2, "Aleli Y Geronimo", "./img/productos/producto41.jpg", false))
productos.push(new Producto(3, "Kit de Masas", "./img/productos/producto2.jpg", true))
productos.push(new Producto(4, "Equilibrio Del Espacio", "./img/productos/producto4.jpg", true))
productos.push(new Producto(5, "Equilibrio De Personas", "./img/productos/producto7.jpg", true))
productos.push(new Producto(6, "Equilibrio De Mar", "./img/productos/producto74.jpg", false))
productos.push(new Producto(7, "Animalitos", "./img/productos/producto14.jpg", false))
productos.push(new Producto(8, "Arcoiris", "./img/productos/producto33.jpg", false))
productos.push(new Producto(9, "Arcoiris", "./img/productos/producto34.jpg", false))
productos.push(new Producto(10, "Bruno", "./img/productos/producto16.png", false))
productos.push(new Producto(11, "Cata", "./img/productos/producto30.jpg", false))
productos.push(new Producto(12, "Oli", "./img/productos/producto58.jpg", false))
productos.push(new Producto(13, "Kit De Pesca", "./img/productos/producto46.jpg", false))
productos.push(new Producto(14, "Kit De Pesca", "./img/productos/producto65.jpg", false))
productos.push(new Producto(15, "Telar De Madera", "./img/productos/producto60.jpg", false))
productos.push(new Producto(16, "Set Viajero", "./img/productos/producto79.jpg", false))
productos.push(new Producto(17, "Ta Te Ti Flores", "./img/productos/producto17.png", true))
productos.push(new Producto(18, "Ta Te Ti Vaquita San Antonio", "./img/productos/producto81.jpg", false))
productos.push(new Producto(19, "Titeres", "./img/productos/producto80.jpg", false))
productos.push(new Producto(20, "Emojis", "./img/productos/producto76.jpg", false))
productos.push(new Producto(21, "Cuenta-Cuentos", "./img/productos/producto78.jpg", false))
productos.push(new Producto(22, "Memotest", "./img/productos/producto72.jpg", false))
productos.push(new Producto(23, "Rompecabeza", "./img/productos/producto56.jpg", false))
productos.push(new Producto(24, "Rompecabeza Árbol", "./img/productos/producto53.jpg", false))
productos.push(new Producto(25, "Rompecabeza Pato", "./img/productos/producto57.jpg", false))
productos.push(new Producto(26, "Rompecabeza Koala", "./img/productos/producto36.jpg", false))
productos.push(new Producto(27, "Rompecabeza Rinoceronte", "./img/productos/producto37.jpg", false))
productos.push(new Producto(28, "Rompecabeza Dinosaurio", "./img/productos/producto45.jpg", false))
productos.push(new Producto(29, "Rompecabeza Tigre", "./img/productos/producto55.jpg", false))
productos.push(new Producto(30, "Cinta De Viento", "./img/productos/producto66.jpg", false))
productos.push(new Producto(31, "Pizarrón", "./img/productos/producto71.jpg", false))
